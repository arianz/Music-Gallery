<?php
    if (isset($_GET['pesan']) && $_GET['pesan'] === 'gagal') {
        $error = isset($_GET['error']) ? $_GET['error'] : "Incorrect username or password!";
        echo "<script>
        ...
        <div class="card card-purple my-2">
            <div class="card-body">
                ...
                <form action="login_process.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a href="register.php"><button type="button" class="btn btn-outline-dark btn-block">Sign up</button></a>
                        </div>
                        <div class="col-6">
                ...
                <p class="mt-3"><a href="../index.php">Back to home</a>
            </div>
        </div>
    </div>
