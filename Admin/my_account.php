...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE users SET username = '$newUsername', password = '$newPassword' WHERE id = $id_akun";
...
<head>
    <!-- ... (head section with CSS and other scripts) ... -->
    <meta charset="utf-8">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-4 text-center">Edit My Account</h4>
                                    <form method="post">
                                        <div class="form-group">
                                            <label for="new_username">New Username :</label>
                                            <input type="text" class="form-control" id="new_username" name="new_username" value="<?php echo $namaAkun; ?>" required>
                                        </div>
                                        <div class="form-group">
